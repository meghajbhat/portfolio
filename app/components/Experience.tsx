        ...
        <div className="space-y-12">
          ...
          <div className="group relative">
            <div className="flex gap-8 items-start">
              <div className="w-16 h-16 rounded-full bg-[#1A2333] border border-emerald-500/20 flex items-center justify-center overflow-hidden">
                <div className="text-2xl font-bold text-emerald-400">C</div>
              </div>
            ...
            <Link 
              ...
              className="absolute inset-0 rounded-xl ring-1 ring-inset ring-emerald-500/20 group-hover:ring-emerald-500/40 transition-all duration-300"
              aria-label="Learn more about CDSAML experience"
            />
          </div>
          ...
          <div className="group relative">
            ...
            <Link 
              ...
              className="absolute inset-0 rounded-xl ring-1 ring-inset ring-emerald-500/20 group-hover:ring-emerald-500/40 transition-all duration-300"
              aria-label="Learn more about Nexus Info experience"
            />
          </div>
        </div>
      </div>
