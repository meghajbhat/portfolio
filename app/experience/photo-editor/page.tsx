...
import { FaGithub, FaArrowLeft, FaImage, FaCode, FaBrain, FaFilter, FaCrop, FaAdjust, FaMagic } from 'react-icons/fa';
import '../../globals.css';
            ...
            <div className="card-3d relative transform-gpu transition-all duration-500 preserve-3d">
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-12 border border-emerald-500/20 hover:border-emerald-500/50 transition-all duration-500">
                ...
                <p className="text-xl text-gray-400 mb-8 text-center max-w-3xl mx-auto">
                  A Python-based application for image processing with various filters and transformations
                </p>
                <div className="flex flex-wrap gap-4 justify-center">
                  ...
                  <span className="px-6 py-3 text-sm rounded-xl bg-[#0B1121]/80 text-emerald-400 border border-emerald-500/30 hover:border-emerald-500/70 transition-all duration-300 transform hover:scale-110">OpenCV</span>
                  <span className="px-6 py-3 text-sm rounded-xl bg-[#0B1121]/80 text-emerald-400 border border-emerald-500/30 hover:border-emerald-500/70 transition-all duration-300 transform hover:scale-110">Tkinter</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500 h-full">
                <div className="absolute -top-6 left-6">
                  <div className="w-12 h-12 bg-[#0B1121] rounded-xl border border-emerald-500/30 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                    <FaImage className="text-2xl text-emerald-400" />
                  </div>
                </div>
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500 h-full">
                ...
                <ul className="space-y-4 text-gray-400">
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    ...
                    <span>Multiple filter effects</span>
                  </li>
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span>Image cropping and resizing</span>
                  </li>
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span>Contrast and brightness adjustment</span>
                  </li>
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span>Special effects (X-ray, Pencil Sketch)</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-gray-300">Basic Filters</h3>
                    <ul className="space-y-3 text-gray-400">
                      ...
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                        <span>X-ray Effect</span>
                      </li>
                    </ul>
                  </div>
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-gray-300">Image Adjustments</h3>
                    <ul className="space-y-3 text-gray-400">
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
