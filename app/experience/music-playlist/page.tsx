...
import { FaGithub, FaArrowLeft, FaMusic, FaCode, FaBrain, FaYoutube, FaUser, FaList, FaPlay, FaRandom } from 'react-icons/fa';
import '../../globals.css';
            ...
            <div className="card-3d relative transform-gpu transition-all duration-500 preserve-3d">
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-12 border border-emerald-500/20 hover:border-emerald-500/50 transition-all duration-500">
                ...
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
                  <div className="relative w-24 h-24">
                    ...
                    <div className="absolute inset-1 bg-[#1A2333] rounded-2xl flex items-center justify-center">
                      <FaMusic className="text-4xl text-emerald-400" />
                    </div>
                  </div>
                </div>
                ...
                <p className="text-xl text-gray-400 mb-8 text-center max-w-3xl mx-auto">
                  A C-based program for managing music playlists with YouTube integration and dynamic user management
                </p>
                <div className="flex flex-wrap gap-4 justify-center">
                  <span className="px-6 py-3 text-sm rounded-xl bg-[#0B1121]/80 text-emerald-400 border border-emerald-500/30 hover:border-emerald-500/70 transition-all duration-300 transform hover:scale-110">C</span>
                  ...
                  <span className="px-6 py-3 text-sm rounded-xl bg-[#0B1121]/80 text-emerald-400 border border-emerald-500/30 hover:border-emerald-500/70 transition-all duration-300 transform hover:scale-110">YouTube API</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500 h-full">
                <div className="absolute -top-6 left-6">
                  <div className="w-12 h-12 bg-[#0B1121] rounded-xl border border-emerald-500/30 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                    <FaMusic className="text-2xl text-emerald-400" />
                  </div>
                </div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  A comprehensive music playlist management system built in C with Python integration for YouTube search functionality. The program features user management, playlist operations, and a stack-based playback system for an enhanced music listening experience.
                </p>
              </div>
            </div>
            ...
            <div className="card-3d relative transform-gpu transition-all duration-500 preserve-3d group">
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500 h-full">
                ...
                <ul className="space-y-4 text-gray-400">
                  ...
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span>Playlist operations (add, delete, shuffle)</span>
                  </li>
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    <span className="text-emerald-400 mt-1">•</span>
                  ...
                  <li className="flex items-start gap-3 transform hover:translate-x-2 transition-transform">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span>Stack-based playback history</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="relative bg-[#1A2333]/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-gray-300">Data Structures</h3>
                    <ul className="space-y-3 text-gray-400">
                      ...
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                        <span>Playlist linked list</span>
                      </li>
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-gray-300">Core Features</h3>
                    <ul className="space-y-3 text-gray-400">
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                        <span>CSV file handling</span>
                      </li>
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                        <span>YouTube API integration</span>
                      </li>
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                        <span>Playlist shuffling</span>
                      </li>
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-gray-300">User Interface</h3>
                    <ul className="space-y-3 text-gray-400">
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                      ...
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
                        <span>Song information display</span>
                      </li>
                      <li className="flex items-center gap-3 transform hover:translate-x-2 transition-transform">
                        <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
